...
class SURREAL(BaseDataset):
    def __init__(self, transform, data_split):
        ...
        self.img_dir = osp.join('data', 'SURREAL', 'images', self.data_split)
        self.annot_path = osp.join('data', 'SURREAL', 'data')
    ...
    def load_data(self):
        db = COCO(osp.join(self.annot_path, f'{self.data_split}.json'))
        ...
        for aid in db.anns.keys():
            ...
            joint_cam = np.array(ann['joint_cam'], dtype=np.float32).reshape(24,-1)
